...
function cachepurger_register_settings() {
   ...
   add_option( 'cf_key_value', wp_slash($_POST['cf_key_value']));
   register_setting( 'cachepurger_options_group', 'cf_key_value' );

   add_option( 'cf_email_value', wp_slash($_POST['cf_email_value']));
   register_setting( 'cachepurger_options_group', 'cf_email_value' );
    
   // save caching settings
   add_option( 'cf_check_homepage', wp_slash($_POST['cf_check_homepage']));
   register_setting( 'cachepurger_options_group', 'cf_check_homepage' );

   add_option( 'cf_check_postpage', wp_slash($_POST['cf_check_postpage']));
   register_setting( 'cachepurger_options_group', 'cf_check_postpage' );
    
   add_option( 'cf_check_httphttps', wp_slash($_POST['cf_check_httphttps']));
   register_setting( 'cachepurger_options_group', 'cf_check_httphttps' );

   add_option( 'cf_check_allcache', wp_slash($_POST['cf_check_allcache']));
...
function salcode_add_plugin_page_settings_link( $links ) {
	$links[] = '<a href="' .
		admin_url( 'options-general.php?page=cf-cachepurger' ) .
		'">' . __('Settings') . '</a>';
	return $links;
}
